...
dsadd group "cn=itGP, ou=IT, dc=gyakorlat, dc=local"
...
FOR /L %%A IN (1,1,9) DO (
    ...
    dsadd user "CN=info%%A, OU=IT, dc=gyakorlat,dc=local" -pwd %pass% -pwdneverexpires yes -samid info%%A -upn info%%A -memberof "cn=itGP, ou=IT, dc=gyakorlat, dc=local"
